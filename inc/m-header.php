  ...
  <header class="header_section">
    ...
    <div class="main-nav-container">
      <nav class="main-nav">
        <ul class="navbar-nav  ">
          <li class="nav-item">
            <a class="nav-link" href="m-profile.php">Profile</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="m-membership.php">Membership</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="m-personalplan.php">Personal Plan </a>
          </li>
          <li class="nav-item">
